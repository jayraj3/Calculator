...
public class Rates
{
    ...
    /// <summary>
    /// Get the value of a property of class by name
    /// </summary>
    /// <param name="propertyName"></param>
    /// <returns></returns>
    public float GetCurrencyRate(string propertyName)
    {
        return (float)this.GetType().GetProperty(propertyName).GetValue(this, null); 
    }
}
